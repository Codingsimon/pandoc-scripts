...
echo BASE_DIR $BASE_DIR OUTPUT_DIR $OUTPUT_DIR OUTPUT_FORMAT $OUTPUT_FORMAT START
...
echo BASE_DIR $BASE_DIR OUTPUT_DIR $OUTPUT_DIR OUTPUT_FORMAT $OUTPUT_FORMAT END
